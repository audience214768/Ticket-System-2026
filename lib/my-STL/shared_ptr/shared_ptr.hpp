...
class shared_ptr {
 ...
 public:
  ...
  shared_ptr &operator=(const shared_ptr &other) {
    ...
    //std::cerr << "4 " << ptr << " " << *refCount << std::endl;
    return *this;
  }
  shared_ptr &operator=(shared_ptr &&other) noexcept {
    ...
    //std::cerr << "5 " << ptr << " " << *refCount << std::endl;
    return *this;
  }
  void release() {
    if (ptr) {
